...
public class CollectedGoods extends GoodsPrice{
    ...
    public static CollectedGoods newCollectedGoods(Collected gcp) throws InstantiationException, IllegalAccessException {
    	CollectedGoods gp =CollectedGoods.class.newInstance();
    	gp.setId(gcp.getId());
		...
		gp.setAddPrice(gcp.getAddPrice());
