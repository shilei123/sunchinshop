...
public interface SearcHistoryMapper {
	...
	public List<cn.sqhl.shop.to.SearcHistory> querySearchHistoryList(@Param(PaginationInterceptor.PAGE_PARAM_KEY) PageCond page,@Param("map") Map<String, Object> map);
}